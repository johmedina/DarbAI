            ...
            <>
              ...
              {total > 1 && (
                <div style={{
                  ...
                  >
                    {t('ui.next')} <ChevronRight size={15} />
                  </button>
                </div>
              )}
              ...
              <div style={{
                ...
                <img
                  ...
                  alt={t('ui.pagePrefix') + ' ' + current.page_num}
                ...
                <div style={{
                  ...
                  {t('ui.pagePrefix')} {current.page_num}
                </div>
              </div>
                ...
                <div style={{
                  ...
                  {pages.map((p, i) => (
                    ...
                    >
                      <img
                        src={p.image_url}
                        alt={t('ui.pageShortPrefix') + p.page_num}
                        style={{ width: "100%", display: "block" }}
                      />
                      <div style={{
                        ...
                        {t('ui.pageShortPrefix')}{p.page_num}
                      </div>
                    </button>
                  ))}
                </div>
